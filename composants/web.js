    ...
    if(innwidth<=460){//mobile version
        ...
        return(
            ...
            <div className="phonecontent">
                ...
                <p style={{color:'darkorange', textAlign:'center', letterSpacing:'2px', fontWeight:'600', fontSize:'120%'}}>Offres Site Web</p><br />
                        ...
                        if(offers[id].category==='Site Web'){
                            return(
                                ...
                                <section>
                                    ...
                                    <button className='btn'><Link to={`/webappview/${offers[id].id}`}><img src={seeicon} alt='del' style={{width:"60%"}} /></Link></button>
                                </section>
                        ...
                        return(
                            ...
                            <div className="desktopcontent">
                                ...
                                <p style={{color:'darkorange', textAlign:'center', letterSpacing:'2px', fontWeight:'600', fontSize:'160%'}}>Offres Site Web</p><br />
