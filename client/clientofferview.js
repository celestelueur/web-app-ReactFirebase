      ...
      <div className="screen">
        ...
        <p><img src={a.arr} alt='offerimg' style={{width:'80%', height:'10%',  borderRadius:'20px 20px'}} /></p>
                ...
                <p style={{color:'white', textAlign:'center', letterSpacing:'2px', fontWeight:'600', fontSize:'80%'}}>Catégorie: {a.category}</p>
                                    <p style={{color:'white', marginBottom:'4%', letterSpacing:'1px', width:'90%', lineHeight:'150%', wordWrap:'break-word', marginLeft:'5%'}}>{a.description}</p><br /></div>
                                    <Link to='/'>
...
export default ClientOfferView
const mystyle={
  btn:{
    border:'none',
    width:'50%',
